...
import { User, AddedUser, UserSchema, AddedUserSchema } from "@/modules/user/domain/user.entity";

export class AddUserUC {
    constructor(private userRepo: IUserRepo) {}

    async execute(input: AddedUser): Promise<User> {
        const validatedUser = AddedUserSchema.safeParse(input)
